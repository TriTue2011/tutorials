...
## 5. Add Control to Your Dashboard (Optional)

If you want to manually change colors or Light/Dark mode directly from your main screen.
_Requirement: [Mushroom Cards](https://github.com/piitaya/lovelace-mushroom) must be installed._
