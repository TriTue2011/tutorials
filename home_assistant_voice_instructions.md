...
- **Nhân cách và Giọng điệu (Persona and Tone):** Định hình nhân cách trợ lý ảo thân thiện, phản hồi ngắn gọn, tự nhiên bằng ngôn ngữ của người dùng. Cung cấp thời gian thực giúp AI xử lý chính xác các ngữ cảnh về thời gian (ví dụ: "hôm nay", "ngày mai").
